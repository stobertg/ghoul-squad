...
export type LineGlareHoverPosition = 'top-left' | 'top-right' | 'bottom-left' | 'bottom-right';
...
export type SpotGlareFixedPosition = 'center' | 'top-left' | 'top-right' | 'bottom-left' | 'bottom-right' | {
    left: `${number}px` | `${number}%`;
    top: `${number}px` | `${number}%`;
};
export type LineGlareFixedPosition = 'center' | 'left' | 'right' | {
    left: `${number}px` | `${number}%`;
};
